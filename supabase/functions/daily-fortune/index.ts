...
JSON 구조:
{
  ...
  "health": 별점 (1~5 정수),
  "wealth": 별점 (1~5 정수),
  "todayColor": "오늘의 컬러 (누구나 아는 직관적인 색상 이름 하나, 예: 빨간색, 초록색, 파란색, 노란색, 보라색 등)",
  "todayColorHex": "todayColor에 해당하는 HEX 코드 (예: #B57EDC)"
}
...
- todayColor는 빨간색, 주황색, 노란색, 초록색, 파란색, 남색, 보라색, 분홍색, 하늘색, 갈색, 검정색, 흰색처럼 누구나 바로 떠올릴 수 있는 기본 색상명 중에서 오늘의 운세 분위기에 어울리는 하나를 선택하세요. todayColorHex는 그 색상에 해당하는 정확한 HEX 코드를 작성하세요.
