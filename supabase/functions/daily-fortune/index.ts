...
JSON 구조:
{
  "message": "7단어 이내의 운세 요약 문장 (~에요, ~세요 체)",
  "explanation": "애정운, 건강운, 재물운에 대한 상세 풀이 (3~4문장, ~에요, ~세요 체)",
...
규칙:
- message는 7단어 이내로 짧고 임팩트 있게 작성하세요 (~에요, ~세요 체). 예: "오늘은 잠깐 쉬어가는 하루에요!"
- explanation은 애정운, 건강운, 재물운 각각에 대해 구체적으로 풀이하세요 (~에요, ~세요 체).
