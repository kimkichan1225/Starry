...
| sky_constellations 테이블 생성 | [ ] 대기 | 등록된 별자리 |

### Phase 2: 3D 뷰어 개발
| 작업 | 상태 | 비고 |
|------|------|------|
| 3D 구형 하늘 컴포넌트 | [x] 완료 | SkyDemoPage.jsx |
...
| 작업 | 상태 | 비고 |
|------|------|------|
| 3D 밤하늘 메인 페이지 | [x] 완료 | /sky-demo (데모) |
| 등록 모드 UI | [ ] 대기 | 3D 터치로 위치 선택 |
| 빈 자리 자동 찾기 | [ ] 대기 | 버튼 클릭 시 빈 위치로 이동 |
| 등록 확인 팝업 | [ ] 대기 | 미리보기 + 확인/취소 |

### Phase 4: 기능 완성
| 작업 | 상태 | 비고 |
|------|------|------|
| 내 별자리 불러오기 | [ ] 대기 | 기존 stars 테이블 연동 |
| 위치 충돌 검사 | [ ] 대기 | 선착순 로직 |
| 별자리 터치 정보 표시 | [x] 완료 | 제작자 닉네임 표시 |
| Supabase 연동 | [ ] 대기 | 등록/조회 API |
...
- HomePage에 3D 밤하늘 버튼 이미 추가됨 (/sky-demo)
