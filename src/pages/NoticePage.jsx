...
function NoticePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#030025]">
      ...
      {/* 메인 콘텐츠 */}
      <div className={`relative z-10 flex flex-col min-h-screen ${authLoading || user ? 'pb-20' : ''}`}>
        {/* 광고 배너 영역 */}
          ...
          <div className="max-w-[370px] mx-auto flex items-center justify-between">
            {!authLoading && !user ? (
              <>
                ...
                <span className="text-white font-bold text-xl">{t.notice.title}</span>
                <div className="w-9" />
              </>
            ) : (
            ...
            {(authLoading || user) && (
              <div className="flex items-center mb-6 -mx-6 px-7">
                <div className="flex items-center gap-1">
                  ...
                  <h2 className="text-white font-bold text-lg">{t.notice.title}</h2>
                </div>
              </div>
            )}
            ...
            <div className="rounded-lg overflow-hidden">
              ...
              <div>
                {loading ? (
                  ...
                  <div className="text-center text-white py-8">{t.notice.noNotices}</div>
                ) : (
