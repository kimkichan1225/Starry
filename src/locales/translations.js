export const translations = {
  ko: {
    ...
    home: {
      ...
      pageTutorial: {
        step1Title: '님, 환영해요!✨',
        step1Desc: '친구들의 마음을 모아\n나만의 별자리를 만들어보세요.',
        step2Title: '링크 공유하기',
        step2Desc: '소중한 사람들에게 링크로\n질문을 던져보세요.',
        step2Copy: '내 링크 복사',
        step3Title: '별 수집하기',
        step3Desc: '친구들의 한 마디 한 마디가\n반짝이는 별로 쌓여요.',
        step4Title: '별자리 완성',
        step4Desc: '모인 별들이 이어져\n나만의 별자리가 탄생해요!',
        step5Title: '오늘의 운세 확인',
        step5Desc: '완성된 별자리로 매일 달라지는\n특별한 운세를 확인하세요.',
      },
    },
  ...
  en: {
    ...
    home: {
      ...
      saving: 'Saving...',
      constellationName: 'What constellation am I?',
      ...
      pageTutorial: {
        step1Title: ', welcome!✨',
        step1Desc: "Gather your friends' hearts\nand create your own constellation.",
        step2Title: 'Share Your Link',
        step2Desc: 'Send your link to people\nyou care about and ask a question.',
        step2Copy: 'Copy My Link',
        step3Title: 'Collect Stars',
        step3Desc: 'Every message from your friends\nbecomes a shining star.',
        step4Title: 'Complete Your Constellation',
        step4Desc: 'Your gathered stars connect\nto form your own constellation!',
        step5Title: "Check Today's Fortune",
        step5Desc: 'See the special fortune\nthat changes daily with your constellation.',
      },
    },
