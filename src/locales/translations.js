      ...
      questions: [
        {
          ...
          options: [
            { label: 'The courage to build', description: 'an escape raft' },
            { label: 'Survival skills', description: 'to hunt for food' },
            { label: 'Knowledge to tell', description: 'toxic plants apart' },
            { label: 'The heart to care', description: 'for teammates' },
          ],
        },
        {
          ...
          options: [
            { label: '"I\'ll do it"', description: 'grab the leader role' },
            { label: 'Just do my part', description: 'leader or not' },
            { label: '"Even better"', description: 'redo the whole topic' },
            { label: 'Calm everyone', description: 'so no one fights' },
          ],
        },
        {
          ...
          options: [
            { label: 'Become besties', description: 'with total strangers' },
            { label: 'Stare at the phone', description: 'till someone talks' },
            { label: 'Smile awkwardly', description: 'when eyes meet' },
            { label: 'Wild outfit,', description: 'radiating presence' },
          ],
        },
        {
          ...
          options: [
            { label: 'A teamfight right', description: 'before a win streak' },
            { label: '"Just between us,"', description: 'hearing a secret' },
            { label: 'Getting praised', description: 'in front of everyone' },
            { label: 'All-night chats', description: 'about love stories' },
          ],
        },
        {
          ...
          options: [
            { label: 'Order spicy rice cakes,', description: 'straight to bed' },
            { label: 'Rant on the phone', description: 'to vent it out' },
            { label: 'Hit the karaoke', description: 'and belt high notes' },
