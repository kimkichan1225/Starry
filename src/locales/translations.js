export const translations = {
  ko: {
    ...
    user: {
      ...
      deleteNotice1: '계정과 받은 별, 별자리, 통계, 별가루 등 모든 데이터가 즉시 삭제되며 복구할 수 없어요.',
      deleteNotice2: '내가 방장인 비공개 밤하늘은 가장 먼저 들어온 멤버에게 방장이 넘어가요. 다른 멤버가 없으면 함께 삭제돼요.',
      deleteNotice3: '탈퇴 후 같은 휴대폰 번호로 다시 가입할 수 있어요.',
      deletePasswordPlaceholder: '비밀번호를 입력해주세요',
      deletePasswordRequired: '비밀번호를 입력해주세요.',
      deleteConfirmWord: '탈퇴',
      deleteConfirmPlaceholder: (word) => `확인을 위해 '${word}'를 입력해주세요`,
      deleteConfirmRequired: (word) => `'${word}'를 정확히 입력해주세요.`,
      deleteInvalidPassword: '비밀번호가 일치하지 않습니다.',
      deleteFailed: '탈퇴 처리에 실패했습니다. 잠시 후 다시 시도해주세요.',
      deleteCancel: '취소',
      deleteSubmit: '탈퇴하기',
      deleting: '처리 중...',
    },
    ...
    consent: {
      ...
      age: '[필수] 만 14세 이상입니다',
      view: '보기',
      privacySummaryTitle: '개인정보 수집·이용 안내',
      privacySummaryItems: '수집 항목: 이메일, 비밀번호(암호화 저장), 휴대폰 번호, 이름 또는 닉네임, 생년월일',
      privacySummaryPurpose: '이용 목적: 회원 식별 및 본인·연령 확인, 맞춤형 스타리 콘텐츠 제공, 부정 이용 방지',
      privacySummaryPeriod: '보유 기간: 회원 탈퇴 시 지체 없이 파기 (관련 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관)',
      privacySummaryRefuse: '동의를 거부할 수 있으나, 거부 시 회원가입 및 서비스 이용이 제한됩니다.',
      required: '필수 항목에 모두 동의해주세요.',
      under14: '만 14세 미만은 가입할 수 없습니다.',
      invalidBirthdate: '올바른 생년월일을 선택해주세요.',
      saveFailed: '동의 내용 저장에 실패했습니다. 다시 시도해주세요.',
    },
  ...
  en: {
    ...
    user: {
      ...
      deleteNotice1: 'Your account and all data, including received stars, constellations, stats and star dust, will be deleted immediately and cannot be recovered.',
      deleteNotice2: 'Private skies you own will be handed over to the earliest member. If there are no other members, they will be deleted.',
      deleteNotice3: 'You can sign up again with the same phone number afterwards.',
      ...
      deleteConfirmRequired: (word) => `Please type '${word}' exactly.`,
      deleteInvalidPassword: 'Incorrect password.',
      deleteFailed: 'Failed to delete your account. Please try again later.',
      deleteCancel: 'Cancel',
      deleteSubmit: 'Delete',
      deleting: 'Deleting...',
    },

    // Consent (Sign up / Profile setup)
    consent: {
      agreeAll: 'Agree to all',
      terms: '[Required] Terms of Service',
      privacy: '[Required] Collection and use of personal information',
      age: '[Required] I am 14 years of age or older',
      view: 'View',
      privacySummaryTitle: 'About personal information collection',
      privacySummaryItems: 'Items: email, password (encrypted), phone number, name or nickname, date of birth',
      privacySummaryPurpose: 'Purpose: member identification, identity and age verification, personalized Starry content, fraud prevention',
      privacySummaryPeriod: 'Retention: deleted without delay upon account deletion (kept for the period required by law where applicable)',
      privacySummaryRefuse: 'You may refuse, but sign up and use of the service will be restricted.',
      required: 'Please agree to all required items.',
      under14: 'Users under 14 cannot sign up.',
